...
class TestGameBoardModule(unittest.TestCase):
  ...
  def testSingleLinesToMap(self):
    self.assertEqual(board.GameBoard.LinesToMap(["WATER, SWAMP, DESERT, WATER, PLAIN"]),
      {(0,0): common.Terrain.WATER, (0,1) : common.Terrain.WATER, (0,2): common.Terrain.SWAMP, (0,3): common.Terrain.SWAMP,
       (0,4): common.Terrain.DESERT, (0,5): common.Terrain.DESERT, (0,6): common.Terrain.WATER, (0,7): common.Terrain.WATER.WATER,
       (0,8): common.Terrain.PLAIN, (0,9) : common.Terrain.PLAIN})
  ...
  def testMultiLinesToMap(self):
    ...
    self.assertEqual(board.GameBoard.LinesToMap([firstRow, secondRow]), {
      (0,0) : common.Terrain.SWAMP, (0,1): common.Terrain.SWAMP, (0,2): common.Terrain.DESERT, (0,3): common.Terrain.DESERT, (0,4) : common.Terrain.LAKE, (0,5): common.Terrain.LAKE, 
      (1,0) : common.Terrain.WATER, (1,1): common.Terrain.WASTELAND, (1,2): common.Terrain.WASTELAND, (1,3): common.Terrain.FOREST, (1,4): common.Terrain.FOREST, (1,5): common.Terrain.WATER,
    })
...
class TestGameBoard(unittest.TestCase):
  ...
  def testDefaultGameTerrainEdgeCases(self):
    ...
    self.assertEqual(board.GetTerrain("A", 2), common.Terrain.MOUNTAIN) # Second.
    self.assertEqual(board.GetTerrain("A", 12), common.Terrain.WASTELAND) # Second to last.
    ...
    self.assertEqual(board.GetTerrain("B", 11), common.Terrain.WATER) # Second to last.
